...
const EnhancedGlobe = lazy(() => import("@/components/EnhancedGlobe"));
const LiveEarthquakeMap = lazy(() => import("@/components/LiveEarthquakeMap"));
const DataJourney = lazy(() => import("@/components/DataJourney"));
  ...
  return (
    <div className="min-h-screen bg-[var(--deep-navy)] text-[var(--off-white)] overflow-x-hidden">
      ...
      <section id="home" className="relative min-h-screen grid-bg overflow-hidden">
        <Suspense fallback={<div className="absolute inset-0 bg-[var(--deep-navy)]" />}>
          <EnhancedGlobe />
        </Suspense>
      ...
      <Suspense fallback={<div className="h-screen bg-[var(--deep-navy)]" />}>
        <StoryMap />
        <DataJourney />
      </Suspense>
            ...
            >
              <div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6" style={{ fontFamily: 'Space Grotesk', color: 'var(--cyber-cyan)' }}>
                  <DecodingText text="Meet the Architect" delay={200} />
                </h2>
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="mb-6">
                  <img
                    src="/images/profile-shaurya.jpg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
            ...
            >
              <div className="relative h-64 sm:h-80 md:h-96 rounded-xl overflow-hidden" style={{ background: `linear-gradient(to bottom right, var(--deep-navy), var(--charcoal))` }}>
                <img
                  src="/images/satellite-earth.jpg"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Suspense fallback={<div className="glass-morphism rounded-2xl p-8 h-96 animate-pulse" />}>
                <LiveEarthquakeMap />
              </Suspense>
            </motion.div>
          </div>
      ...
      {/* Data Journey - Scrollytelling Section */}
      <Suspense fallback={<div className="min-h-screen bg-[var(--charcoal)]" />}>
        <DataJourney />
      </Suspense>

      {/* Before/After Comparison */}
      <Suspense fallback={<div className="py-24 bg-[var(--deep-navy)]" />}>
        <BeforeAfterSlider />
      </Suspense>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          >
            <h2 className="text-5xl font-bold mb-6" style={{ fontFamily: 'Space Grotesk', color: 'var(--cyber-cyan)' }}>
              <DecodingText text="Let's Build the Future" />
            </h2>
            <div className="w-24 h-1 mx-auto mb-8" style={{ backgroundColor: 'var(--cyber-cyan)' }}></div>
            <p className="text-xl max-w-3xl mx-auto" style={{ color: 'var(--light-gray)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold mb-6" style={{ fontFamily: 'Space Grotesk', color: 'var(--cyber-cyan)' }}>
                Start Your Project
              </h3>
              <ContactForm />
            </motion.div>
